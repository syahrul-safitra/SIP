                        ...
                        <div class="col-lg-10">
                            <div class="card-body">
                                    ...
                                    <select class="form-control select-anak @error('kode_anak') is-invalid @enderror"
                                        ...
                                        @if (@old('kode_anak', $imunisasi->kode_anak))
                                            @foreach ($anaks as $anak)
                                                @if (@old('kode_anak', $imunisasi->kode_anak) === $anak->kode)
                                    ...
                                    <select class="form-control @error('jenis_imunisasi') is-invalid @enderror"
                                        ...
                                        @if (@old('jenis_imunisasi', $imunisasi->jenis_imunisasi))
                                            @foreach ($jenis_imunisasis as $jenis)
                                                @if (@old('jenis_imunisasi', $imunisasi->jenis_imunisasi) === $jenis)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            name="tanggal" value="{{ old('tanggal', $imunisasi->tanggal) }}"
                                            id="tanggal">
                                        @error('tanggal')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <input id="catatan" type="hidden" value="{{ old('catatan', $imunisasi->catatan) }}"
