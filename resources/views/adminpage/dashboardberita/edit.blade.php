    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <form action="{{ url('dashboard/berita/' . $berita->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                        name="judul" value="{{ old('judul', $berita->judul) }}" id="judul"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            name="tanggal" value="{{ old('tanggal', $berita->tanggal) }}" id="tanggal">
                                        @error('tanggal')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <input id="deskripsi" type="hidden" value="{{ old('deskripsi', $berita->deskripsi) }}"
