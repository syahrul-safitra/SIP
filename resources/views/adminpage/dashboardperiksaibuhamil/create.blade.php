...
@section('container')
    <div class="col-lg-12">
        ...
        <div class="card mb-4">
            ...
            <form action="{{ url('dashboard/periksaibuhamil') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-10">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('berat_badan') is-invalid @enderror"
                                    ...
                                    placeholder="Masukan Berat Badan (kg)" step="any">
                                @error('berat_badan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('umur_kehamilan') is-invalid @enderror"
                                    name="umur_kehamilan" value="{{ old('umur_kehamilan') }}" id="umur_kehamilan"
                                    placeholder="Masukan Umur Kehamilan" step="any">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tindakan') is-invalid @enderror"
                                    name="tindakan" value="{{ old('tindakan') }}" id="tindakan"
